...
\Author{
\hl{Elena Bonvech}      $^{1,}$*\orcidA{}, %EB: my name is Elena Bonvech, email is ptrwww@mail.ru
Dmitry Chernov     $^{1}$\orcidB{}, 
Miroslav Finger    $^{2,3}$\orcidF{}, 
\hl{Michael Finger} $^{2,3}$\orcidJ{}, %mdpi: the Michael Finger, Jr. is different from susy, please check %EB: The word Jr. is used to distinguish M.Finger and M.Finger Jr. when names are presented with one first letter. If the name Michael is fully written the Jr. can be omitted. We omit Jr. here, but keep it in other places.
...
$^{2}$ \quad  \hl{Faculty of Mathematics and Physics,} Charles University, \hl{18000 Prague}, Czech Republic; Miroslav.Finger@cern.ch~(M.F.); Michael.Finger@cern.ch~(M.F.J.)\\ %mdpi: please check if the address is sorted from subordinate to superior. please check and revise. please add post code %EB: checked and corrected
...
%EB: please arrange Figures 7,8, and 9 to one page if possible
\begin{figure}[H]    
%    \begin{minipage}[t]{0.48\textwidth}
%        \centering
...
\funding{Miroslav Finger and Michael Finger were supported by MEYS of Czech Republic \hl{grant LTT18021.}} %EB: funding was changed
...
\newblock {In \hl{Proceedings of the 31st International Cosmic Ray Conference, Lodz, Poland. 7-15 July 2009}}, { 2009}. %mdpi: please add conference location and date %EB: data and location were added
\newblock Available online: \url{https://arxiv.org/abs/0912.5355} (\hl{accessed on 23 December 2021}).%mdpi: please add accessed date (day month year) %EB: date was added
