...
\begin{figure*}[btp]
    ...
    \includegraphics[width=0.92\textwidth]{figs/frames_bw_after_new.pdf}
...
%%% Data frame Pulses and Sums
    \includegraphics[width=0.9\textwidth]{figs/pulses.pdf}%
...
\label{fig:pulses}
\vspace{1.2pc}
    \includegraphics[width=0.9\textwidth]{figs/mosaic_sums_lin.pdf}%
    \vspace{-1.0pc}
