...
Since the Cherenkov light from EAS has a very sharp directional pattern and could not be observed by detectors more than about 0.5--1~km far from the shower axis. Therefore the IACTs have relatively low upper energy threshold.

The compact detector that observes large surface area, however, can combine some strong sides of a IACT with high upper energy threshold. 
...
% блок-схема выстравления порогов
% блок-схема триггера
...
% поднять наверх описание датчиков (Чернов)
...
\begin{tabular}{||c||}
\hline
\href{https://docs.google.com/spreadsheets/d/1MEnVT2ue2mNZBabXCuhiacFWPkZbzGb2yeg4IZIXusI/edit?usp=sharing}{Table with parameters} \\
\hline
\end{tabular}
...
\caption{Detector inclination vs detector drift from the start point.}
