...
The \mbox{SPHERE-2} detector is a compact optical device designed to measure the EAS Cherenkov light from the balloon elevated to altitudes up to 1~km above the Earth snow covered surface. Special tethered balloon BAPA was developed and used~\cite{Ant20}.% (by Russian Augur balloon systems agency~\cite{Augur}.
%\todoi{Поставить ссылку на статью по аппаратуре.}

The \mbox{SPHERE-2} detector optics comprised a 1.5~m diameter spherical mirror with a 109 photomultiplier tube (PMT) mosaic (optical scheme of the detector is shown in Fig.~\ref{fig:optics}).
