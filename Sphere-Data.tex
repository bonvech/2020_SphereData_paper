...
\begin{figure}[tb]
    ...
    \caption{The SPHERE-2 detector drift in 2012-3 flight. Retina projection to the show surface is given for the time 15:47 UTC. Detector GPS position at that moment is indicated by the cross.  \todoi{Покрасить пятна как на картинке 11. Подписать берег, указать момент времени.}}
...
\centering
    ...
    \caption{The SPHERE-2 PMT retina scheme. PMT numbers are indicated. PMTs are colored according to it current curve type in 2012-3 flight with colors as in Fig. figure~\ref{fig:2012-3_currents}. \todoi{Расписать подробнее что это вообще такое.}}
