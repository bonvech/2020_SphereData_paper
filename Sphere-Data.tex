...
\begin{figure}[tb]
    ...
    \caption{Example of anomalous GPS altitude, compared with barometric height; red band shows interval with GPS data glitch (top panel). Same data with digital high-pass Butterworth filter applied, showing distinguished regions of good and bad correlation of GPS and barometric data (middle panel). Smoothed delta of data on the middle panel with threshold, above which correction is applied to GPS data.}
\label{fig:h_corr}
\end{figure}
