...
%\hline
\hline
\multirow{6}{*}{1 sec} & \multirow{3}{*}{Detector position} &GPS altitude &&& m a.s.l.\\
                                                      \cline{3-6}
                       &                              & GPS coordinates &&&\\
                                                      \cline{3-6}
                       &                              & GPS time &&&\\
                       \cline{2-6}
                       & \multirow{2}{*}{Detector orientation} & inclination angles& 0.1&$-$90--90&deg\\
                                                      \cline{3-6}
                       &                              & compass azimuth &0.1&0--360&deg\\
                       \cline{2-6}
                       &Control block                 & inner temperature&&&deg, C\\
\hline
\multirow{7}{*}{1 min} & \multirow{2}{*}{PMT status} & anode current &&& mA\\
                                                      \cline{3-6}
