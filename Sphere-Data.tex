...
The telemetry data written to binary file is: event number, localtime, two inclination angles, gps data, trigger time, magnitometer angle, currents for 109 PMT, measured before the trigger. 
In addition to PMT data the following event information is stored: GPS  coordinates, altitude, UTC time, local time, trigger time, angles of detector inclination, magnetometer data, every PMT average anode currents. 
